...
// Colores historicos de los equipos (fondo del badge circular)
const TEAM_COLORS = {
  // La Liga (Espana)
  'Athletic Club': 'linear-gradient(135deg, #ee2523 50%, #ffffff 50%)',
  'Athletic': 'linear-gradient(135deg, #ee2523 50%, #ffffff 50%)',
  'Club Atlético de Madrid': 'linear-gradient(135deg, #cb3524 50%, #ffffff 50%)',
  'Atlético de Madrid': 'linear-gradient(135deg, #cb3524 50%, #ffffff 50%)',
  'Atleti': 'linear-gradient(135deg, #cb3524 50%, #ffffff 50%)',
  'CA Osasuna': 'linear-gradient(135deg, #d2122e 50%, #003da5 50%)',
  'Osasuna': 'linear-gradient(135deg, #d2122e 50%, #003da5 50%)',
  'RCD Espanyol de Barcelona': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Espanyol': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'FC Barcelona': 'linear-gradient(135deg, #a50044 50%, #004d98 50%)',
  'Barça': 'linear-gradient(135deg, #a50044 50%, #004d98 50%)',
  'Getafe CF': 'linear-gradient(135deg, #005ca9 50%, #ffffff 50%)',
  'Getafe': 'linear-gradient(135deg, #005ca9 50%, #ffffff 50%)',
  'Málaga CF': 'linear-gradient(135deg, #1b3a6b 50%, #ffffff 50%)',
  'Málaga': 'linear-gradient(135deg, #1b3a6b 50%, #ffffff 50%)',
  'Real Madrid CF': 'linear-gradient(135deg, #ffffff 50%, #d4af37 50%)',
  'Real Madrid': 'linear-gradient(135deg, #ffffff 50%, #d4af37 50%)',
  'Rayo Vallecano de Madrid': 'linear-gradient(135deg, #ffffff 50%, #cc0000 50%)',
  'Rayo Vallecano': 'linear-gradient(135deg, #ffffff 50%, #cc0000 50%)',
  'Levante UD': 'linear-gradient(135deg, #cc0000 50%, #003da5 50%)',
  'Levante': 'linear-gradient(135deg, #cc0000 50%, #003da5 50%)',
  'Real Betis Balompié': 'linear-gradient(135deg, #00954c 50%, #ffffff 50%)',
  'Real Betis': 'linear-gradient(135deg, #00954c 50%, #ffffff 50%)',
  'Real Sociedad de Fútbol': 'linear-gradient(135deg, #004c97 50%, #ffffff 50%)',
  'Real Sociedad': 'linear-gradient(135deg, #004c97 50%, #ffffff 50%)',
  'Villarreal CF': 'linear-gradient(135deg, #ffe600 50%, #004c97 50%)',
  'Villarreal': 'linear-gradient(135deg, #ffe600 50%, #004c97 50%)',
  'Valencia CF': 'linear-gradient(135deg, #ffffff 50%, #f6a000 50%)',
  'Valencia': 'linear-gradient(135deg, #ffffff 50%, #f6a000 50%)',
  'Deportivo Alavés': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Alavés': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Elche CF': 'linear-gradient(135deg, #ffffff 50%, #007a3d 50%)',
  'Elche': 'linear-gradient(135deg, #ffffff 50%, #007a3d 50%)',
  'RC Celta de Vigo': 'linear-gradient(135deg, #6caee0 50%, #ffffff 50%)',
  'Celta Vigo': 'linear-gradient(135deg, #6caee0 50%, #ffffff 50%)',
  'Celta': 'linear-gradient(135deg, #6caee0 50%, #ffffff 50%)',
  'Sevilla FC': 'linear-gradient(135deg, #ffffff 50%, #d71920 50%)',
  'Sevilla': 'linear-gradient(135deg, #ffffff 50%, #d71920 50%)',
  'RC Deportivo La Coruña': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Deportivo': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Girona FC': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Girona': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'UD Las Palmas': 'linear-gradient(135deg, #ffde00 50%, #003da5 50%)',
  'Las Palmas': 'linear-gradient(135deg, #ffde00 50%, #003da5 50%)',
  'UD Almería': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Almería': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Cádiz CF': 'linear-gradient(135deg, #ffdd00 50%, #003da5 50%)',
  'Cádiz': 'linear-gradient(135deg, #ffdd00 50%, #003da5 50%)',
  'RCD Mallorca': 'linear-gradient(135deg, #cc0000 50%, #000000 50%)',
  'Mallorca': 'linear-gradient(135deg, #cc0000 50%, #000000 50%)',
  'Real Valladolid CF': 'linear-gradient(135deg, #7b2d8b 50%, #ffffff 50%)',
  'Valladolid': 'linear-gradient(135deg, #7b2d8b 50%, #ffffff 50%)',
  'Granada CF': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Granada': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Leganés': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'CD Leganés': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  // Premier League (Inglaterra)
  'Arsenal FC': 'linear-gradient(135deg, #ef0107 50%, #ffffff 50%)',
  'Arsenal': 'linear-gradient(135deg, #ef0107 50%, #ffffff 50%)',
  'Aston Villa FC': 'linear-gradient(135deg, #670e36 50%, #95bfe5 50%)',
  'Aston Villa': 'linear-gradient(135deg, #670e36 50%, #95bfe5 50%)',
  'Chelsea FC': 'linear-gradient(135deg, #034694 50%, #ffffff 50%)',
  'Chelsea': 'linear-gradient(135deg, #034694 50%, #ffffff 50%)',
  'Everton FC': 'linear-gradient(135deg, #003399 50%, #ffffff 50%)',
  'Everton': 'linear-gradient(135deg, #003399 50%, #ffffff 50%)',
  'Fulham FC': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'Fulham': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'Liverpool FC': 'linear-gradient(135deg, #c8102e 50%, #ffffff 50%)',
  'Liverpool': 'linear-gradient(135deg, #c8102e 50%, #ffffff 50%)',
  'Manchester City FC': 'linear-gradient(135deg, #6cabdd 50%, #ffffff 50%)',
  'Manchester City': 'linear-gradient(135deg, #6cabdd 50%, #ffffff 50%)',
  'Man City': 'linear-gradient(135deg, #6cabdd 50%, #ffffff 50%)',
  'Manchester United FC': 'linear-gradient(135deg, #da020a 50%, #000000 50%)',
  'Manchester United': 'linear-gradient(135deg, #da020a 50%, #000000 50%)',
  'Man United': 'linear-gradient(135deg, #da020a 50%, #000000 50%)',
  'Newcastle United FC': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Newcastle United': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Newcastle': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Tottenham Hotspur FC': 'linear-gradient(135deg, #ffffff 50%, #132257 50%)',
  'Tottenham Hotspur': 'linear-gradient(135deg, #ffffff 50%, #132257 50%)',
  'Tottenham': 'linear-gradient(135deg, #ffffff 50%, #132257 50%)',
  'West Ham United FC': 'linear-gradient(135deg, #7a263a 50%, #1bb1e7 50%)',
  'West Ham': 'linear-gradient(135deg, #7a263a 50%, #1bb1e7 50%)',
  'Wolverhampton Wanderers FC': 'linear-gradient(135deg, #fdb913 50%, #000000 50%)',
  'Wolverhampton': 'linear-gradient(135deg, #fdb913 50%, #000000 50%)',
  'Wolves': 'linear-gradient(135deg, #fdb913 50%, #000000 50%)',
  'Sunderland AFC': 'linear-gradient(135deg, #eb172b 50%, #ffffff 50%)',
  'Sunderland': 'linear-gradient(135deg, #eb172b 50%, #ffffff 50%)',
  'Hull City AFC': 'linear-gradient(135deg, #f5a12d 50%, #000000 50%)',
  'Hull City': 'linear-gradient(135deg, #f5a12d 50%, #000000 50%)',
  'Leeds United FC': 'linear-gradient(135deg, #ffffff 50%, #ffcd00 50%)',
  'Leeds United': 'linear-gradient(135deg, #ffffff 50%, #ffcd00 50%)',
  'Ipswich Town FC': 'linear-gradient(135deg, #003ea6 50%, #ffffff 50%)',
  'Ipswich Town': 'linear-gradient(135deg, #003ea6 50%, #ffffff 50%)',
  'Nottingham Forest FC': 'linear-gradient(135deg, #dd0000 50%, #ffffff 50%)',
  'Nottingham Forest': 'linear-gradient(135deg, #dd0000 50%, #ffffff 50%)',
  'Crystal Palace FC': 'linear-gradient(135deg, #c4122e 50%, #0057a8 50%)',
  'Crystal Palace': 'linear-gradient(135deg, #c4122e 50%, #0057a8 50%)',
  'Brighton & Hove Albion FC': 'linear-gradient(135deg, #0057b8 50%, #ffffff 50%)',
  'Brighton & Hove Albion': 'linear-gradient(135deg, #0057b8 50%, #ffffff 50%)',
  'Brighton': 'linear-gradient(135deg, #0057b8 50%, #ffffff 50%)',
  'Brentford FC': 'linear-gradient(135deg, #e30613 50%, #ffffff 50%)',
  'Brentford': 'linear-gradient(135deg, #e30613 50%, #ffffff 50%)',
  'AFC Bournemouth': 'linear-gradient(135deg, #da291c 50%, #000000 50%)',
  'Bournemouth': 'linear-gradient(135deg, #da291c 50%, #000000 50%)',
  'Coventry City FC': 'linear-gradient(135deg, #59cbe8 50%, #ffffff 50%)',
  'Coventry City': 'linear-gradient(135deg, #59cbe8 50%, #ffffff 50%)',
  'Leicester City FC': 'linear-gradient(135deg, #003090 50%, #fdbe11 50%)',
  'Leicester City': 'linear-gradient(135deg, #003090 50%, #fdbe11 50%)',
  'Southampton FC': 'linear-gradient(135deg, #d71920 50%, #ffffff 50%)',
  'Southampton': 'linear-gradient(135deg, #d71920 50%, #ffffff 50%)',
  // Serie A (Italia)
  'AC Milan': 'linear-gradient(135deg, #fb090b 50%, #000000 50%)',
  'Milan': 'linear-gradient(135deg, #fb090b 50%, #000000 50%)',
  'ACF Fiorentina': 'linear-gradient(135deg, #4b0082 50%, #ffffff 50%)',
  'Fiorentina': 'linear-gradient(135deg, #4b0082 50%, #ffffff 50%)',
  'AS Roma': 'linear-gradient(135deg, #8b0000 50%, #f5a623 50%)',
  'Roma': 'linear-gradient(135deg, #8b0000 50%, #f5a623 50%)',
  'Atalanta BC': 'linear-gradient(135deg, #1e3f6e 50%, #000000 50%)',
  'Atalanta': 'linear-gradient(135deg, #1e3f6e 50%, #000000 50%)',
  'Bologna FC 1909': 'linear-gradient(135deg, #cc0000 50%, #1a1a1a 50%)',
  'Bologna': 'linear-gradient(135deg, #cc0000 50%, #1a1a1a 50%)',
  'Cagliari Calcio': 'linear-gradient(135deg, #dd0000 50%, #003da5 50%)',
  'Cagliari': 'linear-gradient(135deg, #dd0000 50%, #003da5 50%)',
  'Genoa CFC': 'linear-gradient(135deg, #cc0000 50%, #003da5 50%)',
  'Genoa': 'linear-gradient(135deg, #cc0000 50%, #003da5 50%)',
  'FC Internazionale Milano': 'linear-gradient(135deg, #003399 50%, #000000 50%)',
  'Inter': 'linear-gradient(135deg, #003399 50%, #000000 50%)',
  'Juventus FC': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'Juventus': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'SS Lazio': 'linear-gradient(135deg, #87ceeb 50%, #ffffff 50%)',
  'Lazio': 'linear-gradient(135deg, #87ceeb 50%, #ffffff 50%)',
  'Parma Calcio 1913': 'linear-gradient(135deg, #ffffff 50%, #ffd700 50%)',
  'Parma': 'linear-gradient(135deg, #ffffff 50%, #ffd700 50%)',
  'SSC Napoli': 'linear-gradient(135deg, #12a0c3 50%, #ffffff 50%)',
  'Napoli': 'linear-gradient(135deg, #12a0c3 50%, #ffffff 50%)',
  'Udinese Calcio': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'Udinese': 'linear-gradient(135deg, #ffffff 50%, #000000 50%)',
  'Venezia FC': 'linear-gradient(135deg, #ee8400 50%, #000000 50%)',
  'Venezia': 'linear-gradient(135deg, #ee8400 50%, #000000 50%)',
  'Frosinone Calcio': 'linear-gradient(135deg, #ffe600 50%, #0057a8 50%)',
  'Frosinone': 'linear-gradient(135deg, #ffe600 50%, #0057a8 50%)',
  'US Sassuolo Calcio': 'linear-gradient(135deg, #00703c 50%, #000000 50%)',
  'Sassuolo': 'linear-gradient(135deg, #00703c 50%, #000000 50%)',
  'Torino FC': 'linear-gradient(135deg, #8b1a1a 50%, #ffffff 50%)',
  'Torino': 'linear-gradient(135deg, #8b1a1a 50%, #ffffff 50%)',
  'US Lecce': 'linear-gradient(135deg, #fcd116 50%, #dd0000 50%)',
  'Lecce': 'linear-gradient(135deg, #fcd116 50%, #dd0000 50%)',
  'AC Monza': 'linear-gradient(135deg, #ee2523 50%, #ffffff 50%)',
  'Monza': 'linear-gradient(135deg, #ee2523 50%, #ffffff 50%)',
  'Como 1907': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Hellas Verona FC': 'linear-gradient(135deg, #003399 50%, #f5a623 50%)',
  'Hellas Verona': 'linear-gradient(135deg, #003399 50%, #f5a623 50%)',
  'Empoli FC': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Empoli': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  // Bundesliga (Alemania)
  '1. FC Koeln': 'linear-gradient(135deg, #ee1c25 50%, #ffffff 50%)',
  '1. FC Köln': 'linear-gradient(135deg, #ee1c25 50%, #ffffff 50%)',
  'Köln': 'linear-gradient(135deg, #ee1c25 50%, #ffffff 50%)',
  'TSG 1899 Hoffenheim': 'linear-gradient(135deg, #1961ae 50%, #ffffff 50%)',
  'Hoffenheim': 'linear-gradient(135deg, #1961ae 50%, #ffffff 50%)',
  'Bayer 04 Leverkusen': 'linear-gradient(135deg, #e32221 50%, #000000 50%)',
  'Leverkusen': 'linear-gradient(135deg, #e32221 50%, #000000 50%)',
  'Borussia Dortmund': 'linear-gradient(135deg, #000000 50%, #ffe500 50%)',
  'Dortmund': 'linear-gradient(135deg, #000000 50%, #ffe500 50%)',
  'FC Bayern München': 'linear-gradient(135deg, #dc052d 50%, #ffffff 50%)',
  'Bayern München': 'linear-gradient(135deg, #dc052d 50%, #ffffff 50%)',
  'Bayern': 'linear-gradient(135deg, #dc052d 50%, #ffffff 50%)',
  'FC Schalke 04': 'linear-gradient(135deg, #004d9d 50%, #ffffff 50%)',
  'Schalke': 'linear-gradient(135deg, #004d9d 50%, #ffffff 50%)',
  'Hamburger SV': 'linear-gradient(135deg, #e8001e 50%, #ffffff 50%)',
  'HSV': 'linear-gradient(135deg, #e8001e 50%, #ffffff 50%)',
  'VfB Stuttgart': 'linear-gradient(135deg, #e32221 50%, #ffffff 50%)',
  'Stuttgart': 'linear-gradient(135deg, #e32221 50%, #ffffff 50%)',
  'SV Werder Bremen': 'linear-gradient(135deg, #1d7244 50%, #ffffff 50%)',
  'Werder Bremen': 'linear-gradient(135deg, #1d7244 50%, #ffffff 50%)',
  'Bremen': 'linear-gradient(135deg, #1d7244 50%, #ffffff 50%)',
  '1. FSV Mainz 05': 'linear-gradient(135deg, #c8102e 50%, #ffffff 50%)',
  'Mainz 05': 'linear-gradient(135deg, #c8102e 50%, #ffffff 50%)',
  'Mainz': 'linear-gradient(135deg, #c8102e 50%, #ffffff 50%)',
  'FC Augsburg': 'linear-gradient(135deg, #ba3733 50%, #007a3d 50%)',
  'Augsburg': 'linear-gradient(135deg, #ba3733 50%, #007a3d 50%)',
  'SC Freiburg': 'linear-gradient(135deg, #e8001e 50%, #000000 50%)',
  'Freiburg': 'linear-gradient(135deg, #e8001e 50%, #000000 50%)',
  'Borussia Mönchengladbach': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  "M'gladbach": 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Eintracht Frankfurt': 'linear-gradient(135deg, #e8001e 50%, #000000 50%)',
  'Frankfurt': 'linear-gradient(135deg, #e8001e 50%, #000000 50%)',
  '1. FC Union Berlin': 'linear-gradient(135deg, #e8001e 50%, #ffffff 50%)',
  'Union Berlin': 'linear-gradient(135deg, #e8001e 50%, #ffffff 50%)',
  'SC Paderborn 07': 'linear-gradient(135deg, #0057a8 50%, #000000 50%)',
  'SC Paderborn': 'linear-gradient(135deg, #0057a8 50%, #000000 50%)',
  'SV 07 Elversberg': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Elversberg': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'RB Leipzig': 'linear-gradient(135deg, #dd0000 50%, #ffffff 50%)',
  'VfL Bochum': 'linear-gradient(135deg, #005ca9 50%, #ffffff 50%)',
  'Bochum': 'linear-gradient(135deg, #005ca9 50%, #ffffff 50%)',
  'VfL Wolfsburg': 'linear-gradient(135deg, #65b32e 50%, #ffffff 50%)',
  'Wolfsburg': 'linear-gradient(135deg, #65b32e 50%, #ffffff 50%)',
  'FC St. Pauli': 'linear-gradient(135deg, #5b0c10 50%, #ffffff 50%)',
  'St. Pauli': 'linear-gradient(135deg, #5b0c10 50%, #ffffff 50%)',
  // Primeira Liga (Portugal)
  'FC Porto': 'linear-gradient(135deg, #003087 50%, #ffffff 50%)',
  'Porto': 'linear-gradient(135deg, #003087 50%, #ffffff 50%)',
  'SL Benfica': 'linear-gradient(135deg, #ee1c25 50%, #ffffff 50%)',
  'Benfica': 'linear-gradient(135deg, #ee1c25 50%, #ffffff 50%)',
  'Sporting CP': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'Sporting': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'SC Braga': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Braga': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Vitória SC': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Vitória de Guimarães': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Vitória': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Boavista FC': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Boavista': 'linear-gradient(135deg, #000000 50%, #ffffff 50%)',
  'Rio Ave FC': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'Rio Ave': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'Gil Vicente FC': 'linear-gradient(135deg, #000080 50%, #ffffff 50%)',
  'Gil Vicente': 'linear-gradient(135deg, #000080 50%, #ffffff 50%)',
  'Moreirense FC': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'Moreirense': 'linear-gradient(135deg, #007a3d 50%, #ffffff 50%)',
  'CD Santa Clara': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'Santa Clara': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
  'FC Vizela': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Vizela': 'linear-gradient(135deg, #003da5 50%, #ffffff 50%)',
  'Casa Pia AC': 'linear-gradient(135deg, #000080 50%, #ffffff 50%)',
  'Casa Pia': 'linear-gradient(135deg, #000080 50%, #ffffff 50%)',
  'FC Famalicão': 'linear-gradient(135deg, #cc0000 50%, #000000 50%)',
  'Famalicão': 'linear-gradient(135deg, #cc0000 50%, #000000 50%)',
  'Estrela da Amadora': 'linear-gradient(135deg, #cc0000 50%, #000000 50%)',
  'Estoril Praia': 'linear-gradient(135deg, #ffdd00 50%, #000000 50%)',
  'Estoril': 'linear-gradient(135deg, #ffdd00 50%, #000000 50%)',
  'FC Arouca': 'linear-gradient(135deg, #007a3d 50%, #000000 50%)',
  'Arouca': 'linear-gradient(135deg, #007a3d 50%, #000000 50%)',
  'AVS Futebol SAD': 'linear-gradient(135deg, #cc0000 50%, #ffffff 50%)',
